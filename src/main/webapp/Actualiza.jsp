		...
		<div class="col-12 col-md-6">
			...
			<form class="row g-3 needs-validation" novalidate method="post"
				...
				<div class="col-md-6">
							...
							<input disabled="disabled"  name="codigo" value="${u.codigo}"
								type="text" class="form-control"
								id="" placeholder="">
						</div>
				<div class="col-md-4">
					<label for="validationCustom01" class="form-label">Nombre</label> <input
						type="text" class="form-control" value="${u.nombre}" id="validationCustom01"
						
						name="nombre">
				</div>
				<div class="col-md-4">
					<label for="validationCustom02" class="form-label">Apellido</label>
					<input type="text" class="form-control" value="${u.apellido}" id="validationCustom02"
						name="apellido">
				</div>
				<div class="col-md-4">
					...
					<div class="input-group has-validation">
						<span class="input-group-text" id="inputGroupPrepend">@</span> <input
							...
							aria-describedby="inputGroupPrepend" name="usuario" value="${u.usuario}">
				...
				<div class="col-md-6">
					...
					<input type="password" class="form-control" id="validationCustom08"
						name="clave" maxlength="5" value="${u.clave}">
				</div>
