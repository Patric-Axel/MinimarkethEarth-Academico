    ...
    <div class="bg-white p-3 border rounded shadow-sm">
        ...
        <div class="mb-4">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="cat1">Desinfectantes</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat2">
                <label class="form-check-label" for="cat2">Lavabajillas</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat3">
                <label class="form-check-label" for="cat3">Ambientadores</label>
            </div>
        ...
        <div>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="m1">Sapolio</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="m2">
                <label class="form-check-label" for="m2">Daryza</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="m3">
                <label class="form-check-label" for="m3">Bolivar</label>
            </div>
        </div>
        ...
        <section class="col-12 col-md-9 col-lg-10">
            <h4 class="fw-bold mb-3">Limpieza</h4>
