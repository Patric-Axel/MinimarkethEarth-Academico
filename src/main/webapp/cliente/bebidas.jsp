    ...
    <div class="bg-white p-3 border rounded shadow-sm">
        ...
        <div class="mb-4">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="cat1">Aguas</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat2">
                <label class="form-check-label" for="cat2">Gaseosas</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat3">
                <label class="form-check-label" for="cat3">Jugos</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat4">
                <label class="form-check-label" for="cat4">Energizantes</label>
            </div>
            
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="cat4">
                <label class="form-check-label" for="cat4">Isotónicos</label>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="m1">San luis</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="m2">
                <label class="form-check-label" for="m2">Inca Kola</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="m3">
                <label class="form-check-label" for="m3">Volt</label>
            </div>
        </div>
        ...
        <section class="col-12 col-md-9 col-lg-10">
            <h4 class="fw-bold mb-3">Bebidas</h4>
                 ...
                 <c:forEach var="a" items="${articulo}">
                    <div class="col-6 col-md-4 col-lg-3">
                        <div class="card h-100 shadow-sm">
                            ...
                            <img src="./img/productos/${a.idprod}.jpg" class="card-img-top" alt="${a.descripcion}">
