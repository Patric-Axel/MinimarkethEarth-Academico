				...
				<div class="row">
					<div class="col-4">
						<img alt="imagen del producto"
							src="./img/productos/${pr.idprod}.jpg" width="200px"
							height="200px">
					</div>
					<div class="col-8">

						<form action="actuprod" method="post" class="row g-3">
							<h1>Actualizar Producto</h1>
							<div class="mb-3 row">
								<label for="inputCod" class="col">Codigo:</label> <input
									type="text" value="${pr.idprod}" readonly> <input
									type="hidden" name="codigo" value="${pr.idprod}">
							</div>
							<div class="mb-3 row">
								<label for="inputnom" class="col">Descripcion del
									Producto:</label> <input type="text" name="descripcion"
									value="${pr.descripcion}">
							</div>
							<div class="mb-3 row">
								<label for="inputstock" class="col">Stock:</label> <input
									type="number" name="stock" value="${pr.stock}">
							</div>
							<div class="mb-3 row">
								<label for="inputpre" class="col">Precio:</label> <input
									type="number" step="0.01" name="precio" value="${pr.precio}">
							</div>
